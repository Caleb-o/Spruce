use crate::{name_resolution::NameResolver, sprucetype::SpruceType};
...
//     analyser.add_native_fn(
//         "assert",
//         ParamKind::With(vec![SpruceType::Bool, SpruceType::String]),
//         SpruceType::None,
//     );
//     analyser.add_native_fn(
//         "assert_equal",
...
//     analyser.add_native_fn(
//         "is_ok",
//         ParamKind::With(vec![SpruceType::ErrorOrValue(
//             Box::new(SpruceType::Any),
//             Box::new(SpruceType::Any),
//         )]),
//         SpruceType::Bool,
//     );
