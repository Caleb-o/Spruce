...
// use crate::{token::{Span, Token, TokenKind}, environment::{Environment, ConstantValue, FunctionMeta}, instructions::{Instruction, ParamKind}, nativefns::{self, NativeFunction}, ast::{Ast, AstData}, object::Object, source::Source, RunArgs, error::{SpruceErr, SpruceErrData}, functiondata::Function};
...
//     fn function_call(&mut self, env: &mut Box<Environment>, node: &Box<Ast>) -> Result<(), SpruceErr> {
...
//     fn literal(&mut self, env: &mut Box<Environment>, node: &Box<Ast>) -> Result<(), SpruceErr> {
...
//     fn symbol(&mut self, env: &mut Box<Environment>, node: &Box<Ast>) -> Result<(), SpruceErr> {
...
//     fn ternary_statement(&mut self, env: &mut Box<Environment>, node: &Box<Ast>) -> Result<(), SpruceErr> {
...
//     fn if_statement(&mut self, env: &mut Box<Environment>, node: &Box<Ast>) -> Result<(), SpruceErr> {
...
//     fn trailing_if(&mut self, env: &mut Box<Environment>, node: &Box<Ast>) -> Result<(), SpruceErr> {
...
//     fn switch_case(&mut self, env: &mut Box<Environment>, node: &Box<Ast>) -> Result<(bool, u32), SpruceErr> {
...
//     fn switch_statement(&mut self, env: &mut Box<Environment>, node: &Box<Ast>) -> Result<(), SpruceErr> {
...
//     fn for_statement(&mut self, env: &mut Box<Environment>, node: &Box<Ast>) -> Result<(), SpruceErr> {
...
//     fn do_while_statement(&mut self, env: &mut Box<Environment>, node: &Box<Ast>) -> Result<(), SpruceErr> {
...
//     fn binary_op(&mut self, env: &mut Box<Environment>, node: &Box<Ast>) -> Result<(), SpruceErr> {
...
//     fn unary_op(&mut self, env: &mut Box<Environment>, node: &Box<Ast>) -> Result<(), SpruceErr> {
...
//     fn list_literal(&mut self, env: &mut Box<Environment>, node: &Box<Ast>) -> Result<(), SpruceErr> {
...
//     fn map_literal(&mut self, env: &mut Box<Environment>, node: &Box<Ast>) -> Result<(), SpruceErr> {
...
//     fn var_declaration(&mut self, env: &mut Box<Environment>, var_decl: &Box<Ast>) -> Result<(), SpruceErr> {
...
//     fn var_declarations(&mut self, env: &mut Box<Environment>, var_decls: &Box<Ast>) -> Result<(), SpruceErr> {
...
//     fn var_assign(&mut self, env: &mut Box<Environment>, node: &Box<Ast>) -> Result<(), SpruceErr> {
...
//     fn var_assign_equal(&mut self, env: &mut Box<Environment>, node: &Box<Ast>) -> Result<(), SpruceErr> {
...
//     fn return_statement(&mut self, env: &mut Box<Environment>, node: &Box<Ast>) -> Result<(), SpruceErr> {
...
//     fn program(&mut self, env: &mut Box<Environment>, node: &Box<Ast>) -> Result<(), SpruceErr> {
...
//     fn std_include(&mut self, _env: &mut Box<Environment>, _node: &Box<Ast>) -> Result<(), SpruceErr> {
//         todo!("Std include in compiler");
//     }

//     fn body(&mut self, env: &mut Box<Environment>, node: &Box<Ast>, new_scope: bool) -> Result<(), SpruceErr> {
...
//     fn type_check(&mut self, env: &mut Box<Environment>, node: &Box<Ast>) -> Result<(), SpruceErr> {
...
//     fn function(&mut self, env: &mut Box<Environment>, node: &Box<Ast>) -> Result<(), SpruceErr> {
...
//     fn expression_statement(&mut self, env: &mut Box<Environment>, node: &Box<Ast>) -> Result<(), SpruceErr> {
...
//     fn get_property(&mut self, env: &mut Box<Environment>, node: &Box<Ast>) ->Result<(), SpruceErr> {
...
//     fn set_property(&mut self, env: &mut Box<Environment>, node: &Box<Ast>) ->Result<(), SpruceErr> {
...
//     fn index_getter(&mut self, env: &mut Box<Environment>, node: &Box<Ast>) -> Result<(), SpruceErr> {
...
//     fn index_setter(&mut self, env: &mut Box<Environment>, node: &Box<Ast>) -> Result<(), SpruceErr> {
...
//     fn visit(&mut self, env: &mut Box<Environment>, node: &Box<Ast>) -> Result<(), SpruceErr> {
//         match node.data {
